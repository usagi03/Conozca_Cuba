          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            ...
            <div class="w-full">
              ...
              <label class="block text-sm">
                <span class="block text-sm font-medium leading-6 text-gray-900">{{ $t('login.form.username') }}</span>
                <input
                  ...
                  :placeholder="$t('login.form.user_placeholder')"
              ...
              <label class="block mt-4 text-sm">
                <span class="block text-sm font-medium leading-6 text-gray-900">{{ $t('login.form.password') }}</span>
                <input
                  class="block w-full mt-1 text-sm rounded-md focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                  :placeholder="$t('login.form.user_placeholder')"
  ...
  methods:{
    validarUsuario(){
      if(this.username === ''){
        ...
        this.userError = this.$t('login.errors.user_error');
    ...
    validarContrasenna(){
      if(this.password === ''){
        ...
        this.passError = this.$t('login.errors.password_error');
    ...
    auth: async function() {
      ...
      if(valido){
        ...
        alert(this.$t('login.errors.success')) 
        } else {
        alert(this.$t('login.errors.failed'))  
        } 
      } 
    }
  },
